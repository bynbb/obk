...
| --- | --- |
| ChatGPT / Codex | Tool |
| Gritlabs Preamble scaffold | Component of Gritlabs - a Prompt management and traceability system |
...
| Gritlabs Preamble templates for future use |  |
| XML based workflows |  |
| Git stacked branching workflows based on best practices |  |
...
- 1.1 Familiarize with Gritlabs Preamble scaffold and add to folder
- 1.2 Read articles mentioned in `Key Input Artifacts`
- 1.3 Setup repo based on articles
...
| N-1 | Import Preamble scaffold | Completed |
| N-2 | Setup repo | Completed |
| N-3 | Fill in prompt 20250727T094740-0400 | Completed |
...
- 1. Going to `https://github.com/bynbb/obk/releases` shows changelog and version draft changes e.g.
...
- 2. Commit errors locally without conventional tag</gsl-test>
</gsl-test>
<gsl-test id="T3">

- 3. GitHub runner checks for conventional tag</gsl-test>
</gsl-test>
</gsl-tdd>
...
* This prompt document is backfilled as the prompt template was still in development while after the repo was setup.
...
This specification applies to the prompt with ID <gsl-prompt-id>`20250727T094740-0400`</gsl-prompt-id> located at <gsl-deterministic-path>`prompts/07/27/20250727T094740-0400.md`</gsl-deterministic-path>.
