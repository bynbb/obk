...
<gsl-test id="T3">Running `obk hello-world` prints "hello world" from any directory</gsl-test>
<gsl-test id="T4">Running `obk hello-world -h` shows help for the command</gsl-test>
<gsl-test id="T5">Running `python -m obk hello-world` prints "hello world"</gsl-test>
</gsl-tdd>
```
